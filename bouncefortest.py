...
def update_network(thread_name, G, network_id):
    ndex_dev = nc.Ndex("http://54.213.4.3", username="drh", password="drh")
...
try:
    ...
    # TEST
    thread.start_new_thread(update_network, ('thread-1', noi, '59ea46b0-3c1e-11e6-9037-066b874b801f'))
    thread.start_new_thread(update_network, ('thread-2', noi, '8d5a2741-3c1e-11e6-9037-066b874b801f'))
    thread.start_new_thread(update_network, ('thread-3', noi, 'bb17e692-3c1e-11e6-9037-066b874b801f'))
...
# r = ndex_dev.save_cx_stream_as_new_network(noi.to_cx_stream())
# print r
#
